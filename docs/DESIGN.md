...
> Design notes for **order-journey-embedding-search** — a runnable python example that A typed Python service that embeds and searches checkout, fulfillment, receipt, and customer order events.
...
- **Feature code** — the actual task: order-journey-search.
